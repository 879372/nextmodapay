                ...
                <Card className="rounded-xl bg-pink-900 text-white mx-2">
                    <Accordion type="single" collapsible defaultValue="item-1" className="rounded-xl py-3">
                        <AccordionItem value="item-1">
                            ...
                            <AccordionContent>
                                <Link href="/dashboard" className="flex items-center bg-pink-900 px-8 h-10 w-full py-5 pt-7 hover:text-gray-600">
                    ...
                    <Accordion type="single" collapsible defaultValue="item-4" className="rounded-xl py-3">
                        <AccordionItem value="item-4">
                            ...
                            <AccordionContent>
                                ...
                                <Link href="/" onClick={handleLogout} className="flex items-center bg-pink-900 px-8 h-10 w-full py-5 pt-7 hover:text-gray-600">
